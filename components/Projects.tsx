            ...
            >
              <CardContent sx={{ flexGrow: 1, p: 4 }}>
                ...
                >
                  ...
                  <Chip
                    label={sourceLabels[project.source]}
                    size="small"
                    sx={{
                      flexShrink: 0,
                      border: "1px solid",
                      borderColor:
                        project.source === "OPEN_SOURCE" ? "#22c55e" : "#ef4444",
                      bgcolor:
                        project.source === "OPEN_SOURCE" ? "#dcfce7" : "#fee2e2",
                      color:
                        project.source === "OPEN_SOURCE" ? "#166534" : "#991b1b",
                      fontWeight: 700,
                      boxShadow:
                        project.source === "OPEN_SOURCE"
